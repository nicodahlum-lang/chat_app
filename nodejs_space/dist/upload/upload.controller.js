...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Upload image file (for avatars and message images)' }),
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Bad request - invalid file type or size' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Audio file uploaded successfully' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Bad request - invalid file type or size' }),
    __param(0, (0, common_1.UploadedFile)()),
    __metadata("design:type", Function),
